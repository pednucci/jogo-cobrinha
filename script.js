...
function update (event) {
    if(event.keyCode == 37 || event.keyCode == 65) direction = "left";
    if(event.keyCode == 39 || event.keyCode == 68) direction = "right";
    if(event.keyCode == 38 || event.keyCode == 87) direction = "up";
    if(event.keyCode == 40 || event.keyCode == 83) direction = "down";
}
